...
<div class="container" style="margin: 0; max-width: 1000px;">
	<form action="RemediesInsertServlet" method="post">
		<div class="row">
			<div class="col-md-6">
				<label>Name</label> <input type="text" class="form-control"
					value="${txtRemediesName}" name="txtRemediesName" />${name}
			</div>
		</div>
		<br />
		<div class="row">
		...
		<div class="row">
			<div class="col-md-6">
				<label>Remedies URL for SEO</label> <input type="text"
					class="form-control" value="${txtRemediesURL}"
