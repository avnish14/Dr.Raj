...
<h1>Add Joint Ventures URL Details</h1>
<br>
<br>
<div class="container" style="max-width: 1000px; margin: 0;">
	<form action="JointVenturesURLDetailsInsertServlet" method="post">
		<div class="row">
			<div class="col-md-6">
				<label>URL</label> <select name="txtJointVenturesURL"
					class="form-control">
					...
					<%
						...
						for (int i = 0; i < jointVenturesList.size(); i++) {
							...
							String type = (String) request.getAttribute("txtJointVenturesURL");
		...
		<div class="row">
			<div class="col-md-6">
				<label>Title</label> <input type="text" class="form-control"
					value="${txtSubTitle}" name="txtSubTitle" />${subSubTitle}
			</div>
		</div>
		<br />
		...
		<div class="row">
			<div class="col-md-6">
				<label>PDF Name</label> <input type="text" class="form-control"
					value="${txtPdfName}" name="txtPdfName" />${pdfName}
			</div>
		</div>
		<br />
		...
		<div class="row">
			<div class="col-md-6">
				<label>PDF Link</label> <input type="text" class="form-control"
					value="${txtPdfLink}" name="txtPdfLink" />${pdfLink}
			</div>
		</div>
		<br />
		<div class="row">
